...
int button[] = {2, 4, 5, 8};  //red is button[0], yellow is button[1], green is button[2], blue is button[3]
int led[] = {3, 6, 7, 9};     //red is led[0], yellow is led[1], green is led[2], blue is led[3]
